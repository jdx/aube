...
## [1.18.1](https://github.com/endevco/aube/compare/v1.18.0...v1.18.1) - 2026-06-07

### Fixed

- *(install)* regenerate conflicted lockfiles ([#843](https://github.com/endevco/aube/pull/843))
- *(update)* support global updates ([#840](https://github.com/endevco/aube/pull/840))
...
- *(install)* split fetch pipeline ([#704](https://github.com/endevco/aube/pull/704))
- *(install)* split pipeline modules ([#702](https://github.com/endevco/aube/pull/702))
- *(install)* split helper modules ([#698](https://github.com/endevco/aube/pull/698))

## [1.14.0](https://github.com/endevco/aube/compare/v1.13.1...v1.14.0) - 2026-05-14
...
## [1.13.1](https://github.com/endevco/aube/compare/v1.13.0...v1.13.1) - 2026-05-14

### Fixed

- *(install)* pass version to OSV in transitive MAL-* check ([#682](https://github.com/endevco/aube/pull/682))
