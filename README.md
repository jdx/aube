...
<!-- BENCH_RATIOS:START -->
**[Fast installs](https://aube.jdx.dev/benchmarks).** Warm installs are about 6x faster than pnpm and about 7x faster than Bun in the current benchmarks. Repeat test commands run up to 29x faster than pnpm and up to 5x faster than Bun.
<!-- BENCH_RATIOS:END -->
